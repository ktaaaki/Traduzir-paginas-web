...
Promise.all([twpConfig.onReady(), getTabHostName()]).then(function (_) {
  ...
  const htmlTagsNoTranslate = ["title", "script", "style", "textarea", "svg", "math"];
  ...
  const mutationObserver = new MutationObserver(function (mutations) {
    ...
    mutations.forEach((mutation) => {
      mutation.addedNodes.forEach((addedNode) => {
        ...
        if (!(addedNode instanceof Element && (addedNode.classList.contains("math-container") || addedNode.classList.contains("MathJax")))) {
